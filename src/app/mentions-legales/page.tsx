    ...
    return (
        <section className="body-text gap-4  flex flex-col lg:w-[60%] sm:w-[90%] w-[95%] mx-auto justify-center items-center my-32 sm:my-48">
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <p className="w-full">
                    Tout le contenu du site https://maggystellaire.fr (textes,
                    logos, images et photos) sont la propriété exclusive de
                    Maggy Stellaire comme défini par l'art. 111-1 et suivants du
                ...
                <p className="w-full">
                    ...
                    <Link href="mailto:maggy.stellaire@gmail.com">
                        maggy.stellaire@gmail.com
                    </Link>
                </p>
                ...
                <div className="w-full flex flex-col gap-4">
                    <p className="w-full">
                        ...
                        https://maggystellaire.fr l'identité des différents
                    ...
                    <p className="w-full">
                        ...
                        <br />
                        Maggy GADRAT - Maggy Stellaire <br />
                        E-mail :{" "}
                        <Link href="mailto:maggy.stellaire@gmail.com">
                            maggy.stellaire@gmail.com
                        </Link>
                ...
                <p className="w-full">
                    Maggy GADRAT est propriétaire des droits de propriété
                ...
                <p className="w-full">
                    ...
                    interdite, sauf autorisation écrite préalable de Maggy
                    GADRAT.
                </p>
                <p className="w-full">
                ...
                <p className="w-full">
                    Maggy GADRAT ne pourra être tenu pour responsable des
                    dommages directs et indirects causés au matériel de
                    l’utilisateur, lors de l’accès au site{" "}
                    https://maggystellaire.fr.
                </p>
                <p className="w-full">
                    Maggy GADRAT décline toute responsabilité quant à
                    l’utilisation qui pourrait être faite des informations et
                    contenus présents sur https://maggystellaire.fr.
                </p>
                <p className="w-full">
                    Maggy GADRAT s’engage à sécuriser au mieux le site
                    https://maggystellaire.fr, cependant sa responsabilité ne
                ...
                <p className="w-full">
                    ...
                    sont à la disposition des utilisateurs. Maggy GADRAT se
                ...
                <p className="w-full">
                    Le cas échéant, Maggy GADRAT se réserve également la
                ...
                <p className="w-full">
                    ...
                    , l’utilisateur du site https://maggystellaire.fr dispose
                ...
                <p className="w-full">
                    ...
                    https://maggystellaire.fr n'est publiée à l'insu de
                ...
                <p className="w-full">
                    Le site https://maggystellaire.fr contient des liens
                    hypertextes vers d’autres sites et dégage toute
                    responsabilité à propos de ces liens externes ou des liens
                    créés par d’autres sites vers https://maggystellaire.fr.
                </p>
                <p className="w-full">
                    La navigation sur le site https://maggystellaire.fr est
                ...
                <p className="w-full">
                    ...
                    https://maggystellaire.fr est soumis au droit français. En
                ...
                <p className="w-full">
                    L’utilisation du site https://maggystellaire.fr implique
                    ...
                    https://maggystellaire.fr sont donc invités à les consulter
                    de manière régulière.
                </p>
                <p className="w-full">
                    Ce site est normalement accessible à tout moment aux
                    utilisateurs. Une interruption pour raison de maintenance
                    technique peut être toutefois décidée par Maggy GADRAT, qui
                    s’efforcera alors de communiquer préalablement aux
                    utilisateurs les dates et heures de l’intervention.
                </p>
                <p className="w-full">
                    Le site https://maggystellaire.fr est mis à jour
                    régulièrement par Maggy GADRAT. De la même façon, les

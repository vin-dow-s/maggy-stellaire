        ...
        <section className="body-text gap-4  flex flex-col lg:w-[60%] sm:w-[90%] w-[95%] mx-auto justify-center items-center my-32 sm:my-48">
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <p className="w-full">
                    ...
                    les informations collectées par https://maggystellaire.fr
                    sont traitées, en fournissant également les raisons pour
                    ...
                    web de https://maggystellaire.fr.
                </p>
                <p className="w-full">
                    Maggy Stellaire s'engage à garantir la confidentialité et la
                ...
                <p className="w-full">
                    Lorsque vous visitez https://maggystellaire.fr, certaines
                ...
                <h3 className="text-2xl font-heading mt-16 mb-8 w-full">
                    2 - Pourquoi Maggy Stellaire traite vos données ?
                </h3>{" "}
                <p className="w-full">
                    La priorité absolue est la sécurité des données des
                    visiteurs et, à ce titre, Maggy Stellaire ne peut traiter
                    que des données minimales sur les utilisateurs, uniquement
                    dans la mesure où cela est absolument nécessaire pour
                    maintenir le site web. Les informations collectées
                    automatiquement sont utilisées uniquement pour identifier
                    les cas potentiels d'abus et établir des informations
                    statistiques concernant l'utilisation du site web. Ces
                ...
                <p className="w-full">
                    ...
                    en ligne ou contacter Maggy Stellaire directement à partir
                    du site web. Les utilisateurs qui ne savent pas quelles
                ...
                <p className="w-full">
                    Si vous souhaitez exercer ce droit, veuillez contacter Maggy
                    Stellaire via les coordonnées ci-dessous.
                </p>{" "}
                <p className="w-full">
                    En outre, si vous êtes un résident européen, vos
                    informations seront traitées afin d'exécuter les contrats
                    que Maggy Stellaire pourrait avoir avec vous (par exemple,
                    si vous passez une réservation par le biais du site), ou
                ...
                <p className="w-full">
                    ...
                    divulgation non autorisés. Maggy Stellaire conserve des
                ...
                <p className="w-full">
                    Maggy Stellaire divulguera toute information collectée,
                    ...
                    les droits de Maggy Stellaire et les votres, votre sécurité
                ...
                <p className="w-full">
                    Si vous souhaitez contacter Maggy Stellaire pour comprendre
